...
class AIFactory:
    ...
    def get_ai_description(ai_type: str) -> str:
        descriptions = {
            "fish": "🐟 Рыба - играет много рук, пассивная",
            "nit": "🛡️ Нит - играет только сильные руки, очень тайтовый", 
            "tag": "🎯 TAG - тайтовый агрессивный, балансированная стратегия",
            "lag": "⚡ LAG - лузовый агрессивный, много рейзов"
        }
